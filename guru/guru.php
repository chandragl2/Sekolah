...
$title = "Guru - Universitas Nurtanio";
...
if ($msg == 'added') {
  ...
  <i class="fa-solid fa-circle-check"></i> data dosen Berhasil dihapus ..
...
<div id="layoutSidenav_content">
    ...
    <!-- modal hapus data -->
    <!-- modal hapus data -->
    <div class="modal fade" id="mdlHapus" tabindex="-1" aria-labelledby="mdlHapusLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mdlHapusLabel">Konfirmasi</h5>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', "#btnHapus", function() {
                ...
                $('#btnmdlHapus').attr("href", "hapus-guru.php?id=" + idDosen + "&foto=" + fotoDosen);
            });
        });
    </script>
